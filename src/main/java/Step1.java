...
/*    public enum N{
    ...
    public static class MyMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
        private static final Text astrix = new Text("*");
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setCombinerClass(MyCombiner.class); // TODO - understand if needed
    ...
    public static void writeN(long n, Configuration conf) throws IOException {
